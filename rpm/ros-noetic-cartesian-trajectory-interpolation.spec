...
Name:           ros-noetic-cartesian-trajectory-interpolation
Version:        0.1.4
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS cartesian_trajectory_interpolation package

License:        Apache-2.0
URL:            http://wiki.ros.org/cartesian_trajectory_interpolation
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-noetic-cartesian-control-msgs
Requires:       ros-noetic-joint-trajectory-controller
Requires:       ros-noetic-roscpp
Requires:       ros-noetic-rospy
Requires:       ros-noetic-tf2-eigen
BuildRequires:  ros-noetic-cartesian-control-msgs
