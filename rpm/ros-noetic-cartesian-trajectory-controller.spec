...
Name:           ros-noetic-cartesian-trajectory-controller
Version:        0.1.4
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS cartesian_trajectory_controller package

License:        Apache-2.0
URL:            http://wiki.ros.org/cartesian_trajectory_controller
...
BuildRequires:  ros-noetic-speed-scaling-interface
